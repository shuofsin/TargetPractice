...
function main_menu:init(debug)
    ...
    main_menu.buttons.score = main_menu:create_button("score", gameWidth / 2, gameHeight * 0.7, "assets/sprites/score.png", 1.3)
    main_menu.buttons.exit = main_menu:create_button("exit", gameWidth / 2, gameHeight * 0.85, "assets/sprites/exit.png", 1.3)
